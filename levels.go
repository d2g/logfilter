...
// Convert a string log level (i.e. "Error") to the coresponding Level (i.e. Error).
...
// Convert a Level (i.e. Error) to the coresponding string version (i.e. "Error").
...
// Convert the default log sting sent to the LogLine type.
